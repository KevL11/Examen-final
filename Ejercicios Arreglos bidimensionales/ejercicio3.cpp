...
int main() {
    ...
    //a) Registrar la informaci�n de las ventas por mes de cada una de las agencias.
    ...
    //c) Mostrar cu�l fue el total de ventas en el a�o de la Agencia 3.
    ...
    //e) Mostrar el n�mero de la agencia que tuvo mayores ventas en el mes de mayo.
    ...
    //f) TODO: Indicar en qu� mes se registraron las menores ventas del a�o, considerando todas las agencias. 
